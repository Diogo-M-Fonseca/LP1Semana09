...
namespace PlayerManager1
{
    ...
    public class Program
    {
        ...
        private void ShowMenu()
        {
            ...
            Console.WriteLine("1- Add Player to list");
        ...
        private void InsertPlayer()
        {
            ...
            Console.WriteLine("Insert Their score");
        ...
        {
           Console.WriteLine("List players with a score greater than: ");
           int minScore = int.Parse(Console.ReadLine());
           IEnumerable<Player> playerGreater = GetPlayersWithScoreGreaterThan(minScore);
           ListPlayers(playerGreater);
        }
        ...
        {
            List<Player> greatPlayer = new List<Player>();
            foreach (Player player in playerList)
           {
                if (player.Score > minScore)
                {
                    greatPlayer.Add(player);
                }
           }
           return greatPlayer;
        }
